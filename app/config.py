...
class Settings(BaseSettings):
    ...
    @validator("openai_web_search_context_size")
    def validate_search_context_size(cls, v: str) -> str:
        allowed = {"low", "medium", "high"}
        lv = (v or "").strip().lower()
        return lv if lv in allowed else "medium"
